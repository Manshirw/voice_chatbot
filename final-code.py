...
def wishme():
    ...
    if 0 <= hour < 12:
        text = "Good Morning. I am Rav. How can I Serve you?"
    elif 12 <= hour < 18:
        text = "Good Afternoon. I am Rav. How can I Serve you?"
    else:
        text = "Good Evening. I am Rav. How can I Serve you?"
...
if __name__ == "__main__":
    ...
    #i have to write something right now ,so i decided to write a comment on this vs code platform 
    #that i feceive
    okVar = IntVar()
